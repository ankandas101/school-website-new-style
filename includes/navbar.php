<!-- ===== STICKY NAVBAR ===== -->
<header id="main-header" class="site-header" x-data="{ open: false }" @keydown.escape.window="open = false">
  <nav style="max-width:1280px; margin:0 auto; padding:0.65rem 1rem; display:flex; align-items:center; justify-content:space-between; gap:1rem;">
    ...
    <div style="display:flex; align-items:center; gap:10px; flex-shrink:0;">
      ...
      <!-- Mobile hamburger -->
      <button @click="open = !open" class="lg:hidden" style="padding:8px; border-radius:8px; background:none; border:none; cursor:pointer; color:#374151;" aria-label="Toggle menu">
        <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
        <svg x-show="open" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
      </button>
    </div>
  </nav>

  <!-- Mobile Menu -->
  <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="lg:hidden" style="border-top:1px solid #E8ECF3; background:#fff;" @click.away="open=false">
    <div style="padding:0.75rem 1rem; max-height:80vh; overflow-y:auto;">
      ...
      <div style="padding:6px 12px; font-size:0.7rem; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.05em; margin-top:6px;">স্টুডেন্ট কর্নার</div>
      <a href="<?php echo APP_URL; ?>/dashboard" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">শিক্ষার্থী প্রফাইল লগইন</a>
      <a href="<?php echo APP_URL; ?>/admission" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">অনলাইন ভর্তি</a>
      <a href="<?php echo APP_URL; ?>/certificates" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">Certificates</a>
      <a href="<?php echo APP_URL; ?>/exam_results" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">Exam Results</a>
      <div style="padding:6px 12px; font-size:0.7rem; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.05em; margin-top:6px;">গুরুত্বপূর্ণ তথ্য</div>
      <a href="student_info.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">শিক্ষার্থী তথ্য</a>
      <a href="teachers.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">শিক্ষকবৃন্দ</a>
      <a href="routine.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ক্লাস রুটিন</a>
      <a href="result.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ফলাফল</a>
      <a href="result_archives.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ফলাফল আর্কাইভ</a>
      <a href="management_committee.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ব্যবস্থাপনা কমিটি</a>
      <a href="admission.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ভর্তি তথ্য</a>
      ...
      <div style="padding:6px 12px; font-size:0.7rem; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.05em; margin-top:6px;">অন্যান্য</div>
      <a href="forms.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">সকল ফর্ম</a>
      <a href="student_of_the_year.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">কৃতি শিক্ষার্থী</a>
      <a href="event.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ইভেন্ট</a>
      <a href="photo_gallery.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ছবি গ্যালারি</a>
      <a href="video_gallery.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">ভিডিও গ্যালারি</a>
      <a href="admin/dashboard.php" style="display:block; padding:8px 20px; border-radius:8px; font-size:0.85rem; color:#374151;">Admin Dashboard</a>
